...
class Game:
    ...
    def run_game(self):
        ...
        while ready_to_play != 'no':
            ready_to_play = input(
                "\nHOW ABOUT A NICE GAME OF ROCK PAPER SCISSORS LIZARD SPOCK? ('yes' to play, 'no' to end) ")
    ...
    def game_round(self):
        ...
        if self.player_one.gesture.name in self.player_two.gesture.beats:
            ...
            attack_word_index = self.player_two.gesture.beats.index(
                self.player_one.gesture.name)
            ...
            attack_word_index = self.player_one.gesture.beats.index(
                self.player_two.gesture.name)
